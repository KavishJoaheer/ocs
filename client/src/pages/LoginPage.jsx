...
function LoginPage() {
  ...
  return (
    <div
      className="min-h-dvh bg-[radial-gradient(circle_at_top_right,_rgba(65,200,198,0.18),_transparent_24%),linear-gradient(180deg,_#f8fdfd_0%,_#edf8f8_100%)] px-4 py-8 text-slate-900 lg:px-8"
    ...
    >
      <div className="mx-auto grid min-h-[calc(100dvh-4rem)] max-w-7xl gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
