            ...
            <div className="absolute z-20 mt-1 max-h-[220px] w-full overflow-y-auto rounded-2xl border border-slate-200 bg-white shadow-lg">
              {filteredCatalog.map((catalogItem) => {
                ...
                >
                  ...
                  <span className="shrink-0 text-xs text-slate-500" title="How many you can request right now">
                    {available} available
                  </span>
                </button>
                );
            ...
            items.map((row, idx) => {
              ...
              >
                <div className="min-w-0 flex-1">
                  ...
                  {available != null ? (
                    <p className="text-[11px] text-slate-500" title="How many you can request right now">
                      {available} available
                    </p>
                  ) : null}
                  {shortage ? (
