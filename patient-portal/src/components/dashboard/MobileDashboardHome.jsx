...
function MobileDashboardHome({
  ...
  return (
    <div className="native-dashboard min-h-full bg-[var(--native-canvas)]">
      ...
      {!activeVisitSlot ? (
        <section className="squircle-outer ocs-elevate-hero animate-fade-in-up stagger-1 relative mb-9 overflow-hidden bg-brand-dark-grey px-5 py-2 text-white">
          ...
          <div className="relative z-10 mt-2 grid gap-1">
            <button
              ...
              className="squircle-inner flex min-h-[48px] w-full items-center gap-2 bg-brand-gold px-3 text-left text-brand-dark-grey shadow-[0_4px_12px_rgba(var(--ocs-brand-gold-rgb),0.16)] transition active:scale-[0.98]"
            >
              ...
              <span className="grid size-6 shrink-0 place-items-center rounded-full bg-brand-dark-grey/10">
