...
function MobileBottomNav() {
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 w-full border-t-2 border-teal-500/20 bg-white/90 pb-[env(safe-area-inset-bottom)] shadow-[0_-10px_30px_rgba(0,0,0,0.08)] backdrop-blur-xl lg:hidden"
                ...
                return (
                  <>
                    ...
                    <span className="relative">
                      {isActive ? (
                        <span
                          className="pointer-events-none absolute -bottom-1 left-1/2 h-1.5 w-8 -translate-x-1/2 rounded-full bg-teal-400/35 blur-[3px]"
                          aria-hidden="true"
                        />
                      ) : null}
                      <span
